...
-- Database: `world`
--
INSERT INTO `person` ( `firstName`, `lastName`, `email`, `role`, `password`) VALUES
('Anas', 'Boufangara', 'anassboufangara@gmail.com', 'admin', '$2a$10$nmUqzeFkTLuCgp5PXpl04enVdBOeSIwblzaamid2Bu0tt7PKc8B1u');
-- --------------------------------------------------------
